...
$cookieExpire = time() + (86400 * 30); // Cookie will expire in 30 days
...
if (isset($_POST['username'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        //create_session();
        setcookie($cookieName, $flag, $cookieExpire, "/"); // "/" makes the cookie available throughout the entire domain
